...
Most of these come down to network reality or how gutendex serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gutendex rate-limits like any public site. gutendex already paces
...
Where a surface is gated, gutendex reads a cookie or token you supply
...
`gutendex`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gutendex actually did
